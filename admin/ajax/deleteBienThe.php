...
try {
    ...
    if ($count_orders > 0) {
        ...
        echo json_encode([
            'success' => true,
            'action' => 'deleted',
            'message' => 'Biến thể không có đơn hàng → đã xoá cùng các chi tiết phiếu nhập.'
        ]);
    }
} catch (Exception $e) {
