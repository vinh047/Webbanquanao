...
<body>
  <div class="container py-5 min-vh-100 d-flex align-items-center justify-content-center">
    <div class="row w-100 g-4 flex-column flex-md-row justify-content-center align-items-center">
      
      <!-- Login/Register Form -->
      <div class="col-md-5 bg-white rounded-4 p-4 retro-shadow login">
        <form action="put-user-ondb.php" method="POST" id="mainformmainform">
